...
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item text-center mr-auto">
                <button type="button" class="btn btn-secondary nav-btn" data-toggle="modal" data-target="#donateModal">
                    Donate
                </button>
                <div class="modal fade" id="donateModal" tabindex="-1" role="dialog" aria-labelledby="donateModal" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-left">
                                <p>lightning donation: scalatheagorist@blink.sv</p>
                                <img src="https://image.nostr.build/b4fdbe9b9eb6798c44e68b0ff391065d78ebb9fddad9a151cea2c8de37bd8041.jpg">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">close</button>
                            </div>
